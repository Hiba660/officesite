        ...
        <div class="row">
            <div class="col-xl-12 mx-auto col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    ...
                    <div class="card-body ">
                        <form action="{{ route('backend.testimonial.update',$testimonials->id) }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Description</label>
                                 <textarea name="description" class="form-control" id="basic-example" cols="20" rows="5">{{$testimonials->description}}</textarea>
                            </div>
